...
template <typename SVC_HANDLER>
void ACE_NonBlocking_Connect_Handler<SVC_HANDLER>::timer_id(long id)
{
    ACE_TRACE("ACE_NonBlocking_Connect_Handler<SVC_HANDLER>::timer_id");
    this->timer_id_ = id;
}
...
template <typename SVC_HANDLER>
int ACE_NonBlocking_Connect_Handler<SVC_HANDLER>::handle_exception(ACE_HANDLE h)
{
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::make_svc_handler(SVC_HANDLER *&sh)
{
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::activate_svc_handler(SVC_HANDLER *svc_handler)
{
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::connect_svc_handler(
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::open(ACE_Reactor *r, int flags)
{
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::connect(
    SVC_HANDLER *&sh,
    const typename PEER_CONNECTOR::PEER_ADDR &remote_addr,
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::connect_i(
    SVC_HANDLER *&sh,
    SVC_HANDLER **sh_copy,
    const typename PEER_CONNECTOR::PEER_ADDR &remote_addr,
    const ACE_Synch_Options &synch_options,
    ...
    int perms)
{
    ...
    int result;
    if (sh_copy == 0)//第一个connect sh_copy is 0
        result = this->connect_svc_handler(
            sh,
            remote_addr,
            timeout,
            local_addr,
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::connect_n(
    size_t n,
    SVC_HANDLER *sh[],
    ...
    const ACE_Synch_Options &synch_options)
{
    ...
    {
        if (this->connect(sh[i], remote_addrs[i], synch_options) == -1 && !(synch_options[ACE_Synch_Options::USE_REACTOR] && errno == EWOULDBLOCK))
        {
            result = -1;
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::cancel(SVC_HANDLER *sh)
{
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::nonblocking_connect(SVC_HANDLER *sh,
                                                                    const ACE_Synch_Options &synch_options)
{
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
void ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::initialize_svc_handler(ACE_HANDLE handle,
                                                                        SVC_HANDLER *svc_handler)
{
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
void ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::reactor(ACE_Reactor *reactor)
{
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::close(void)
{
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::fini(void)
{
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::init(int, ACE_TCHAR *[])
{
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::suspend(void)
{
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::resume(void)
{
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Connector<SVC_HANDLER, PEER_CONNECTOR>::info(ACE_TCHAR **strp, size_t length) const
{
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
ACE_Strategy_Connector<SVC_HANDLER, PEER_CONNECTOR>::ACE_Strategy_Connector(ACE_Reactor *reactor,
                                                                            ACE_Creation_Strategy<SVC_HANDLER> *cre_s,
                                                                            ACE_Connect_Strategy<SVC_HANDLER, PEER_CONNECTOR> *conn_s,
                                                                            ACE_Concurrency_Strategy<SVC_HANDLER> *con_s,
                                                                            int flags)
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Strategy_Connector<SVC_HANDLER, PEER_CONNECTOR>::close(void)
{
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
int ACE_Strategy_Connector<SVC_HANDLER, PEER_CONNECTOR>::connect_svc_handler(
    SVC_HANDLER *&sh,
    const typename PEER_CONNECTOR::PEER_ADDR &remote_addr,
    ACE_Time_Value *timeout,
    const typename PEER_CONNECTOR::PEER_ADDR &local_addr,
    ...
    int perms)
{
    return this->connect_strategy_->connect_svc_handler(
        sh,
        remote_addr,
        timeout,
        local_addr,
...
template <typename SVC_HANDLER, typename PEER_CONNECTOR>
ACE_Connect_Strategy<SVC_HANDLER, PEER_CONNECTOR> *

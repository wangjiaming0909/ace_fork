...
ACE_ALLOC_HOOK_DEFINE_Tc(ACE_Select_Reactor_T)
    ...
    int ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::any_ready(ACE_Select_Reactor_Handle_Set &wait_set)
{
...
template <class ACE_SELECT_REACTOR_TOKEN>
int ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::any_ready_i(ACE_Select_Reactor_Handle_Set &wait_set)
{
    ACE_TRACE("ACE_Select_Reactor_T::any_ready_i");

    int const number_ready = this->ready_set_.rd_mask_.num_set() + this->ready_set_.wr_mask_.num_set() + this->ready_set_.ex_mask_.num_set();
...
template <class ACE_SELECT_REACTOR_TOKEN>
int ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::owner(ACE_thread_t tid,
                                                          ACE_thread_t *o_id)
{
...
template <class ACE_SELECT_REACTOR_TOKEN>
int ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::notify(ACE_Event_Handler *eh,
...
template <class ACE_SELECT_REACTOR_TOKEN>
int ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::register_handler(ACE_Event_Handler *handler,
                                                                     ACE_Reactor_Mask mask)
{
...
template <class ACE_SELECT_REACTOR_TOKEN>
ACE_Event_Handler *
ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::find_handler(ACE_HANDLE handle)
{
...
template <class ACE_SELECT_REACTOR_TOKEN>
int ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::remove_handler(const ACE_Handle_Set &handles,
                                                                   ACE_Reactor_Mask mask)
{
...
template <class ACE_SELECT_REACTOR_TOKEN>
int ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::remove_handler(ACE_Event_Handler *handler,
                                                                   ACE_Reactor_Mask mask)
{
    ACE_TRACE("ACE_Select_Reactor_T::remove_handler");
    ACE_MT(ACE_GUARD_RETURN(ACE_SELECT_REACTOR_TOKEN, ace_mon, this->token_, -1));
...
template <class ACE_SELECT_REACTOR_TOKEN>
int ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::open(size_t size,
                                                         bool restart,
                                                         ACE_Sig_Handler *sh,
                                                         ACE_Timer_Queue *tq,
...
{
    if (this->delete_timer_queue_) //if already has one timer_queue_, if need to delete, delete it
    {
        delete this->timer_queue_;
    }
    else if (this->timer_queue_)
    {
        this->timer_queue_->close(); //remove all the nodes in the list
    }
    this->timer_queue_ = tq;
...
ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::ACE_Select_Reactor_T(ACE_Sig_Handler *sh,
                                                                     ...
                                                                     bool mask_signals,
                                                                     int s_queue)
    : ACE_Select_Reactor_Impl(mask_signals), token_(s_queue), lock_adapter_(token_), deactivated_(0)
{
...
template <class ACE_SELECT_REACTOR_TOKEN>
int ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::current_info(ACE_HANDLE, size_t &)
{
    return -1;
}
                                                                     ...
                                                                     ACE_Sig_Action *new_disp)
{
    ...
    for (int s = 1; s < ACE_NSIG; ++s)
        if ((sigset.is_member(s) == 1) && this->signal_handler_->register_handler(s,
                                                                                  new_sh,
                                                                                  new_disp) == -1)
            result = -1;
#else  /* ACE_NSIG <= 0 */
...
#if (ACE_NSIG > 0)
    for (int s = 1; s < ACE_NSIG; ++s)
        if ((sigset.is_member(s) == 1) && this->signal_handler_->remove_handler(s) == -1)
            result = -1;
#else  /* ACE_NSIG <= 0 */
    ACE_UNUSED_ARG(sigset);
#endif /* ACE_NSIG <= 0 */
...
template <class ACE_SELECT_REACTOR_TOKEN>
int ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::reset_timer_interval(
    long timer_id,
    const ACE_Time_Value &interval)
{
...
template <class ACE_SELECT_REACTOR_TOKEN>
ACE_Event_Handler *
ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::find_handler_i(ACE_HANDLE handle)
{
                                                              ...
                                                              ACE_Event_Handler **eh)
{
    ...
    {
        if ((ACE_BIT_ENABLED(mask, ACE_Event_Handler::READ_MASK) || ACE_BIT_ENABLED(mask, ACE_Event_Handler::ACCEPT_MASK)) && this->wait_set_.rd_mask_.is_set(handle) == 0)
            return -1;
        if (ACE_BIT_ENABLED(mask, ACE_Event_Handler::WRITE_MASK) && this->wait_set_.wr_mask_.is_set(handle) == 0)
            return -1;
        if (ACE_BIT_ENABLED(mask, ACE_Event_Handler::EXCEPT_MASK) && this->wait_set_.ex_mask_.is_set(handle) == 0)
            return -1;
    }
...
template <class ACE_SELECT_REACTOR_TOKEN>
int ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::work_pending(const ACE_Time_Value &max_wait_time)
{
...
template <class ACE_SELECT_REACTOR_TOKEN>
int ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::dispatch_timer_handlers(int &number_of_handlers_dispatched)
{
    ...
    ACE_Select_Reactor_Handle_Set &dispatch_set)
{
    ...
    do
    {
        ...
        else if (this->dispatch_notification_handlers(dispatch_set,
                                                      active_handle_count,
        ...
        else if (this->dispatch_io_handlers(dispatch_set,
                                            active_handle_count,
        ...
        if (initial_handle_count == active_handle_count || this->state_changed_)
        {
            active_handle_count = this->any_ready(dispatch_set);
        }
...
template <class ACE_SELECT_REACTOR_TOKEN>
int ACE_Select_Reactor_T<ACE_SELECT_REACTOR_TOKEN>::handle_events_i(ACE_Time_Value *max_wait_time)
{
    int result = -1;
